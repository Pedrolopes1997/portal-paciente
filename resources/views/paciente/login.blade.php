        ...
        tailwind.config = {
            theme: {
                extend: {
                    ...
                    colors: {
                        // Azul padrão que você estava usando
                    ...
                    <form action="{{ route('paciente.login.post', ['tenant_slug' => $tenant->slug]) }}" method="POST" class="space-y-6">
                        ...
                        <div>
                            ...
                            <div class="mt-4 text-center">
                                <a href="{{ route('paciente.password.request', ['tenant_slug' => $tenant->slug]) }}" class="font-semibold text-primary-600 hover:text-primary-500 text-sm">
                                    Esqueceu a senha?
                                </a>
                            </div>
